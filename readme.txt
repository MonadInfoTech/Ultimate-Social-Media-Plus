...
This plugin is a further development of https://wordpress.org/plugins/ultimate-social-media-icons/, giving it even more functions and making it even easier to use at the same time. (We tried to update the other plugin for 2 months, but users reported that their old selections don't get carried over, so there seem to be too many changes, therefore it's a separate plugin). 
