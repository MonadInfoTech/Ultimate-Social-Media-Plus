        ...
        <ul class="sfsiplus_tab_3_icns">
         ...
         <!--------------------start next four------------------------>
            ...
            <p class="radio_section tab_3_option">
                <input name="sfsi_plus_mouseOver" <?php echo ( $option3['sfsi_plus_mouseOver']=='yes') ?  'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  /><label>Mouse-Over effects</label><div class="drop_lsts"><select name="sfsi_plus_mouseOver_effect"  id="sfsi_plus_mouseOver_effect" class="styled"> <option value="fade_in" <?php echo ( $option3['sfsi_plus_mouseOver_effect']=='fade_in') ?  'selected="true"' : '' ;?>>Fade In</option><option value="scale" <?php echo ( $option3['sfsi_plus_mouseOver_effect']=='scale') ?  'selected="true"' : '' ;?>>Scale</option><option value="combo" <?php echo ( $option3['sfsi_plus_mouseOver_effect']=='combo') ?  'selected="true"' : '' ;?>>Combo</option></select></div></p>
            <div class="Shuffle_auto"><p class="radio_section tab_3_option"><input name="sfsi_plus_shuffle_icons" <?php echo ( $option3['sfsi_plus_shuffle_icons']=='yes') ?  'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  /><label>Shuffle them automatically</label></p>
                <div class="sub_sub_box shuffle_sub"  >
                <p class="radio_section tab_3_option"><input name="sfsi_plus_shuffle_Firstload" <?php echo ( $option3['sfsi_plus_shuffle_Firstload']=='yes') ?  'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  /><label>When site is first loaded</label></p>
