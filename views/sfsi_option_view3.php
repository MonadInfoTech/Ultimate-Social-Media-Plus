...
<div class="tab3">
         ...
         <!--------------------start next four------------------------>
              ...
              <div class="sub_row stand sec_new" style="margin-left: 0px;">
                ...
                <p class="radio_section tab_3_option">
                    ...
                    <div class="drop_lsts">
                    	<select name="sfsi_plus_mouseOver_effect"  id="sfsi_plus_mouseOver_effect" class="styled"> <option value="fade_in" <?php echo ( $option3['sfsi_plus_mouseOver_effect']=='fade_in') ?  'selected="true"' : '' ;?>>Fade In</option><option value="scale" <?php echo ( $option3['sfsi_plus_mouseOver_effect']=='scale') ?  'selected="true"' : '' ;?>>Scale</option><option value="combo" <?php echo ( $option3['sfsi_plus_mouseOver_effect']=='combo') ?  'selected="true"' : '' ;?>>Combo</option></select>
                    </div>
                </p>
                <div class="Shuffle_auto">
                	<p class="radio_section tab_3_option">
                    	<input name="sfsi_plus_shuffle_icons" <?php echo ( $option3['sfsi_plus_shuffle_icons']=='yes') ?  'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  /><label>Shuffle them automatically</label>
                    </p>
                	<div class="sub_sub_box shuffle_sub"  >
                		<p class="radio_section tab_3_option">
                        	<input name="sfsi_plus_shuffle_Firstload" <?php echo ( $option3['sfsi_plus_shuffle_Firstload']=='yes') ?  'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  /><label>When site is first loaded</label>
                        </p>
                		<p class="radio_section tab_3_option">
                        	<input name="sfsi_plus_shuffle_interval" <?php echo ( $option3['sfsi_plus_shuffle_interval']=='yes') ?  'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  /><label>Every</label><input class="smal_inpt" type="text" name="sfsi_plus_shuffle_intervalTime" value="<?php echo ( $option3['sfsi_plus_shuffle_intervalTime']!='') ?   $option3['sfsi_plus_shuffle_intervalTime'] : '' ;?>"><label>seconds</label>
                        </p>
                	</div>
                </div>
            </div>
	...
	<div class="save_button tab_3_sav">
	     ...
	     <a href="javascript:;" id="sfsi_plus_save3" title="Save" data-nonce="<?php echo $nonce;?>">Save</a>
